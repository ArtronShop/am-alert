<script lang="ts">
    import { Listgroup, ListgroupItem, Avatar, Button, Input, FooterCopyright } from "flowbite-svelte";
    import {
        Navbar,
        NavBrand,
        NavLi,
...
<div class="m-auto w-80">
    ...
    {#each icons as item, index}
        <ListgroupItem class="focus:ring-0 flex flex-row align-middle" href={`/room/${item.id}`}>
            <Avatar src=" " size="md" />
    ...
    <div class="flex flex-row mb-6">
        <Input type="text" id="add-room-id" placeholder="หมายเลขห้อง" class="grid-rows-1 mr-3" />
